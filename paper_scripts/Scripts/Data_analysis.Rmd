...
test <- wilcox.test(EUB_ARCH_cov[EUB_ARCH_cov$Region == "WSC",]$proportion,
            EUB_ARCH_cov[EUB_ARCH_cov$Region == "N",]$proportion)

p.adjust(test$p.value, method = "bonferroni")

test2 <- wilcox.test(EUB_ARCH_cov[EUB_ARCH_cov$Region == "WSC",]$proportion,
            EUB_ARCH_cov[EUB_ARCH_cov$Region == "EGC",]$proportion)

p.adjust(test2$p.value, method = "bonferroni")

test3 <- wilcox.test(EUB_ARCH_cov[EUB_ARCH_cov$Region == "N",]$proportion,
            EUB_ARCH_cov[EUB_ARCH_cov$Region == "EGC",]$proportion)
...
test7 <- wilcox.test(EUB_sum[EUB_sum$Depth == "SRF",]$FISH.conc.mn,
...
test8 <- wilcox.test(EUB_sum[EUB_sum$Depth == "EPI",]$FISH.conc.mn,
...
test9 <- wilcox.test(EUB_sum[EUB_sum$Depth == "MESO",]$FISH.conc.mn,
...
test10 <- wilcox.test(SAR202_sum[SAR202_sum$Region == "EGC",]$FISH.conc.mn,
            SAR202_sum[SAR202_sum$Region == "N",]$FISH.conc.mn)

p.adjust(test10$p.value, method = "bonferroni")

test11 <- wilcox.test(SAR202_sum[SAR202_sum$Region == "EGC",]$FISH.conc.mn,
            SAR202_sum[SAR202_sum$Region == "WSC",]$FISH.conc.mn)

p.adjust(test11$p.value, method = "bonferroni")

test12 <- wilcox.test(SAR202_sum[SAR202_sum$Region == "N",]$FISH.conc.mn,
            SAR202_sum[SAR202_sum$Region == "WSC",]$FISH.conc.mn)
...
## Significance of depth DAPI between regions
