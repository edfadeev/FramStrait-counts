...
prop16S <- read.csv("/Users/schatz/CARD-FISH/PS99_CARD-FISH_Analysis_final_folder(fill it in the end)/Scripts/PS99_16s_taxa.csv", sep =",", header=T, row.names = 1)
...
#tiff("Figure-3-surface_proportions.tiff", units="cm", width=20, height=23, res=800)
#comparions_plot
#dev.off()
```
