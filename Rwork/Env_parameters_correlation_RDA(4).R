...
cor.test <- na.omit(env[,c("Temperature", "Salinity", "Chla_fluor", "NO3.NO2", "NO2", "NO3", "SiO3", "PO4", "NH4")])
...
#Correlogram
x <- cor(cor.test)
corrplot(x, type="upper", order="hclust", col=brewer.pal(n=8, name="PuOr"), method="pie", addCoef.col = "black", tl.col = "white")
text(1:9, 10.5, expression("Temperature [°C]", "Salinity [PSU]", "Chlorophyll a [µg/L]", "Total N", "NO"[2], "NO"[3], "SiO"[3], "PO"[4],"NH"[4] ), srt = 45)
text(-1, 1:9,  expression("                                                                                                                                                                                                NH"[4],
                          "                                                                                                                                                                      PO"[4],
                          "                                                                                                                                           SiO"[3],
                          "                                                                                                                  NO"[3],
                          "                                                                                               NO"[2], 
...
#extract only epipelagic communities
FISH.ra.SRF <- FISH.ra[FISH.ra$Depth %in% c("DCM","EPI"),]
